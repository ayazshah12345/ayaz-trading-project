  ...
  return (
    <div className="absolute inset-0 pointer-events-none overflow-hidden select-none z-0 bg-[#f8fafc]">
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(ellipse 90% 60% at 50% 0%, rgba(0, 102, 255, 0.07) 0%, rgba(14, 165, 233, 0.04) 40%, rgba(248, 250, 252, 1) 90%), radial-gradient(circle at 85% 45%, rgba(0, 102, 255, 0.05) 0%, transparent 60%), radial-gradient(circle at 15% 65%, rgba(14, 165, 233, 0.04) 0%, transparent 50%)',
        }}
      />
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[1100px] h-[750px] pointer-events-none opacity-[0.20]">
        <svg viewBox="0 0 1100 750" className="w-full h-full" fill="none">
          <ellipse cx="550" cy="375" rx="520" ry="340" stroke="url(#royalBrightBlue)" strokeWidth="1" strokeDasharray="4 8" />
          <ellipse cx="550" cy="375" rx="420" ry="260" stroke="#0066ff" strokeWidth="0.8" strokeDasharray="1 5" />
          <ellipse cx="550" cy="375" rx="320" ry="190" stroke="#0284c7" strokeWidth="0.8" />
          <ellipse cx="550" cy="375" rx="200" ry="120" stroke="#0066ff" strokeWidth="0.6" strokeDasharray="6 12" />
          
          {/* Subtle Crosshairs & Coordinates */}
          <line x1="550" y1="20" x2="550" y2="730" stroke="#0066ff" strokeWidth="0.5" strokeOpacity="0.25" strokeDasharray="4 6" />
          <line x1="20" y1="375" x2="1080" y2="375" stroke="#0066ff" strokeWidth="0.5" strokeOpacity="0.25" strokeDasharray="4 6" />
          
          <defs>
            <linearGradient id="royalBrightBlue" x1="0%" y1="0%" x2="100%" y2="100%">
      ...
      {/* 4. Bright Blue Ambient Lighting Halos */}
      <div className="absolute -top-32 left-1/4 w-[500px] h-[500px] rounded-full bg-blue-500/8 blur-[140px] pointer-events-none" />
      <div className="absolute top-1/3 right-10 w-[600px] h-[600px] rounded-full bg-sky-500/8 blur-[160px] pointer-events-none" />
      <div className="absolute -bottom-20 left-1/3 w-[550px] h-[450px] rounded-full bg-blue-600/6 blur-[130px] pointer-events-none" />
